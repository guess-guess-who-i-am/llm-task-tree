...
- CurrentResult: huangyu repro: 12:49 Codex thread reports task_tree_open unavailable; app-server predates 12:35 plugin install. .task-tree-port=35595 is dead while persistent 5633 is live.
...
- NextIdea: Restart fqd Codex app-server through its control path, open a new session and assert task_tree_focus/open; then make stale port marker self-heal.
