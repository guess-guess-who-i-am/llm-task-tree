...
try {
  ...
  assert.match(overviewText, /当前进度/);
  assert.match(overviewText, /当前问题/);
  ...
  assert(overviewText.replace(/\s+/g, " ").trim().length <= 180, `overview is still too dense: ${overviewText.length}`);
